...
int main(int argc, char **argv)
{
        ...
        //open outfile to save data in
        FILE *fptr;
	//Buffer to store eacj line of file
	char line[256];
        //file not saving, check if its opening
        fptr = fopen("data/c_timetowrite.txt", "r");
        if (fptr == NULL)
        {
        ...
        // just read each line in the file
